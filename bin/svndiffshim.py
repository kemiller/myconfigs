...
#
# This version's verbosity is devoted to generating useful filenames that show up
# in the title bar of the FileMerge window.
#
...
os.execlp("chdiff", "chdiff", "--background", file1Path, file2Path)
